...
func gfxMain(screen *nanogui.Screen) {
	...
	MainNGWindow = nanogui.NewWindow(screen, "Mirball Drives")
	...
	if conf.IsDev {
		// Test data
		testData1 := rclone.Transferring{"Kavkazskaya.plennitsa.1967.Rus.Sub.BDRip.AVC.mkv", 2195316919, 592445440, 26, 1.196727107058912e+07, 1.153178700901072e+07}
		testData2 := rclone.Transferring{"ДМБ (2000) DVDRip-AVC.mkv", 1514794462, 26214400, 41, 1.590787626902579e+07, 4.196312355093148e+06}
		testData3 := rclone.Transferring{"Kavkazskaya.plennitsa.1967.Rus.Sub.BDRip.AVC.mkv", 2195316919, 592445440, 26, 1.196727107058912e+07, 1.153178700901072e+07}
		testData4 := rclone.Transferring{"ДМБ (2000) DVDRip-AVC.mkv", 1514794462, 26214400, 41, 1.590787626902579e+07, 4.196312355093148e+06}
		testData5 := rclone.Transferring{"Kavkazskaya.plennitsa.1967.Rus.Sub.BDRip.AVC.mkv", 2195316919, 592445440, 26, 1.196727107058912e+07, 1.153178700901072e+07}
		testData6 := rclone.Transferring{"ДМБ (2000) DVDRip-AVC.mkv", 1514794462, 26214400, 41, 1.590787626902579e+07, 4.196312355093148e+06}
		testArr[0] = testData1
		testArr[1] = testData2
		testArr[2] = testData3
		testArr[3] = testData4
...
func gfxAbout(screen *nanogui.Screen) {
	...
	homepageURL := "https://github.com/keshon/samuno"
